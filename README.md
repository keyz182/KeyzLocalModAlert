...
```
[h1]KeyzLocalModAlert[/h1]

Alert when your local git managed mods are out of date
...
[url=https://github.com/keyz182/KeyzLocalModAlert][img]https://img.shields.io/static/v1?label=KeyzLocalModAlert&message=Fork%20me%20on%20github&color=d2e885&logo=github[/img][/url]
```
